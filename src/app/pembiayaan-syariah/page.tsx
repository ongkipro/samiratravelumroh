...
export const metadata: Metadata = {
  title: "Cicilan Umroh Syariah — Umroh Dulu, Bayar Belakangan | Samira Travel",
  description:
    "Simulasi cicilan umrah syariah tanpa jaminan bersama AMITRA (Astra Syariah) dan BSI. DP mulai Rp 5 Jt, tenor hingga 36 bulan, akad Murabahah terdaftar OJK.",
  alternates: {
