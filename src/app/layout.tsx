...
export const metadata: Metadata = {
  ...
  title: {
    default: "Samira Travel — Sahabat Umrah & Haji Keluarga Anda | Peringkat #1 Nasional",
  ...
  openGraph: {
    title: "Samira Travel — Sahabat Umrah & Haji Keluarga Anda",
    description:
    ...
    images: [
      {
        url: "/images/banner-hero-1.jpg",
        width: 1200,
        height: 630,
        alt: "Samira Travel Umrah & Haji Keluarga Anda",
      },
    ],
  },
  twitter: {
