  ...
  const otherCertificates = [
    {
      ...
      image: "/images/guinness-world-records-halal-dinner-jeddah.png",
      description:
    ...
    },
    {
      ...
      image: "/images/penghargaan-apsi-2026-jamaah-terbanyak.png",
      description:
  ...
  return (
    <section className="py-16 md:py-24 bg-[#FAF8F5]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-20 space-y-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#0F172A] mt-1">
          ...
          <div className="w-full">
            <Image
              src="/images/tiga-rekor-muri-landscape.png"
        ...
        {/* 2. Secondary Credentials: Guinness World Records & Piala APSI (Museum Placard Styling) */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 mb-24 pt-12 border-t border-[#E8E3DA]">
          {otherCertificates.map((cert, idx) => (
            <div
              key={idx}
              className="flex flex-col justify-between space-y-5 group bg-white rounded-3xl p-6 sm:p-8 border border-[#C5A059]/40 hover:border-[#C5A059] shadow-md hover:shadow-xl transition-all"
            >
              <div className="space-y-4">
                {/* Natural Authentic Showcase: 100% Legible, No Dark Crop */}
                <div className="w-full flex items-center justify-center p-4 sm:p-6 rounded-2xl bg-[#FAF8F5] border border-[#E8E3DA]">
                  <Image
                    src={cert.image}
                    alt={cert.title}
                    width={800}
                    height={500}
                    className="max-h-72 w-auto object-contain transition-transform duration-300 group-hover:scale-[1.02]"
                  />
                </div>
                ...
                <div className="space-y-1.5 pt-1">
                  ...
                  <h3 className="font-playfair text-xl sm:text-2xl font-bold text-[#0F172A] leading-snug">
                    {cert.title}
                  </h3>
        ...
        <div className="mb-24 space-y-6 pt-8 border-t border-[#E8E3DA]">
          <div>
            ...
            <h3 className="font-playfair text-xl sm:text-2xl md:text-3xl font-bold text-[#0F172A]">
